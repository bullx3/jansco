class Room::HistoryController < RoomController
	...
	HISTORIES = [
		...
		},
		{
			no: 4,
			date: "2019-12-27",
			title: "一部のプレイヤー名前表示から直接個人成績を見に行けるようにしました。
			        成績の日付指定を月単位にしました",
		...
		},
		{
			no: 5,
			date: "2019-12-27",
			title: "対局数表示をチップを含まない半荘のみで表示するようにしました",
			body: "トップページや過去の対局結果にの一覧表示で表示される対局数の表示を半荘・チップ含めて加算していたのを半荘のみに変更しました<br>
				  また、対局の詳細なスコア表示で半荘とチップで色分けをしました",
			images: nil,
			link: nil
		},
